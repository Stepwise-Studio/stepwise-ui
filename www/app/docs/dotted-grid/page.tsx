...
import { DottedGridPreview } from '@/components/stepwise/docs/dotted-grid-preview'

const usageCode = `import { DottedGrid } from '@/components/stepwise/dotted-grid'
    ...
    <div className="flex gap-12">
      <div className="flex min-w-0 flex-1 flex-col gap-12">
        ...
        <section className="flex flex-col gap-4">
          ...
          <InlineInstall command="npx stepwise-ui add dotted-grid" />
        </section>

        <section id="preview" className="scroll-mt-20">
          <PreviewCode
            preview={<DottedGridPreview />}
