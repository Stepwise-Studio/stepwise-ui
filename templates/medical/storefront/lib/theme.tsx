...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  /* Light-first, unlike the Stepwise library this was vendored from.
   * MedixGo's whole art direction is ink on cream paper - a dark first paint
   * would be the wrong first impression, and the no-flash script in
   * app/layout.tsx defaults to the same value. */
